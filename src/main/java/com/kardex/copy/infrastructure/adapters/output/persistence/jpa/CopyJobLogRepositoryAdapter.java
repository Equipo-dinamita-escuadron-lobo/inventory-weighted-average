...
/**
 * Adaptador JPA para ICopyJobLogRepositoryPort de kardex WA.
 * REQ-INVWA-01.
 */
@Component("kardexWaCopyJobLogRepositoryAdapter")
...
public class CopyJobLogRepositoryAdapter implements ICopyJobLogRepositoryPort {
    ...
    private CopyJobLogEntity toEntity(CopyJobLog log) {
        return CopyJobLogEntity.builder()
                ...
                .fase(log.getFase())
                .modulo(log.getModulo() != null ? log.getModulo() : "kardex-wa")
